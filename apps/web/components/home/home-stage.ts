...
export const HOME_STAGE: Record<string, HomeStageDir> = {
  "neon-drift": {
    family: "speed",
    copy: "left",
    crop: { desktop: "46% 42%", laptop: "44% 44%", mobile: "58% 38%" },
    tile: "46% 42%",
  ...
  "swarm-protocol": {
    family: "arena",
    copy: "offset",
    crop: { desktop: "50% 50%", laptop: "50% 50%", mobile: "50% 48%" },
    tile: "50% 50%",
  ...
  "sky-stack": {
    family: "vertical",
    copy: "low",
    crop: { desktop: "50% 70%", laptop: "50% 72%", mobile: "50% 68%" },
    tile: "50% 74%",
  ...
  "knockout-circuit": {
    family: "runner",
    copy: "left",
    crop: { desktop: "20% 58%", laptop: "18% 60%", mobile: "16% 62%" },
    tile: "18% 60%",
  ...
  "crowd-control": {
    family: "runner",
    copy: "low",
    crop: { desktop: "50% 38%", laptop: "50% 40%", mobile: "50% 36%" },
    tile: "50% 36%",
