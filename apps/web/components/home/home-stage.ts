...
export const HOME_STAGE: Record<string, HomeStageDir> = {
  ...
  "velocity-run": {
    family: "speed",
    copy: "left",
    crop: { desktop: "38% 70%", laptop: "36% 72%", mobile: "28% 74%" },
    tile: "22% 70%",
    ...
    leftWash: "linear-gradient(90deg, rgba(0,0,0,.38) 0%, rgba(0,0,0,.1) 28%, transparent 52%)",
  ...
  "knockout-circuit": {
    family: "runner",
    copy: "left",
    crop: { desktop: "36% 46%", laptop: "34% 48%", mobile: "30% 50%" },
    tile: "20% 54%",
  ...
  "pocket-striker": {
    family: "diorama",
    copy: "left",
    crop: { desktop: "52% 42%", laptop: "50% 44%", mobile: "48% 40%" },
    tile: "30% 56%",
  ...
  "crowd-control": {
    family: "runner",
    copy: "left",
    crop: { desktop: "28% 74%", laptop: "26% 76%", mobile: "24% 78%" },
    tile: "32% 64%",
    scale: { desktop: 1.16, mobile: 1.1 },
    lift: "-16%",
    glow: "#ff7a59",
