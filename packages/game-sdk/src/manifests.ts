...
export const neonDriftManifest: GameManifest = {
  ...
  minPlayers: 1,
  maxPlayers: 1,
  sessionHint: "90 sec runs",
  howToPlay: [
    "Accelerate into the first corner and hold a slide.",
    "Steer into the drift, then countersteer to keep the angle alive.",
    "Near-miss the inner curb to raise the combo.",
    "Crash ends the run. Two laps is a full circuit.",
  ],
  controls: [
...
export const velocityRunManifest: GameManifest = {
  ...
  howToPlay: [
    ...
    "Jumps are buffered and forgive a breath of late takeoff.",
    "Tap jump again at the apex for a short hop, hold for height.",
    "Death restarts instantly. R always resets.",
  ],
  controls: [
  ...
  faq: [
    { q: "What are medals?", a: "Bronze, Silver, Gold, Platinum — author times are data-driven per course." },
    { q: "Do checkpoints exist?", a: "Courses are short on purpose. A death is a full reset so splits stay honest." },
  ],
  achievements: [
...
export const swarmProtocolManifest: GameManifest = {
  ...
  howToPlay: [
    ...
    "Collect cores to level up and pick one of three upgrades.",
    "Dash through danger — i-frames are visible.",
    "Survive the escalating protocol. Death is the result screen.",
  ],
  controls: [
    { input: "WASD / arrows", action: "Move" },
    { input: "Shift / click", action: "Dash" },
